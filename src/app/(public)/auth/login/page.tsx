    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4">
        <Link href="/" className="flex items-center gap-2">
          ...
          <img src="/icon.png" alt="Logos Zoe" className="w-7 h-7 rounded-lg object-cover" />
          <span className="font-semibold text-gray-900 text-sm">Logos Zoe</span>
        </Link>
        <span className="text-sm text-gray-500">
          No account?{" "}
          <Link href="/auth/register" className="text-gray-900 font-medium hover:text-gray-800">
            Sign up
          </Link>
        </span>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link href="/auth/forgot-password" className="text-xs text-gray-900 hover:text-gray-800">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 rounded-lg bg-gray-900 text-white text-sm font-semibold hover:bg-gray-800 transition-colors disabled:opacity-60 disabled:cursor-not-allowed mt-2"
              >
